        ...
        <TooltipProvider>
            ...
            >
                ...
                <div className="flex flex-col flex-grow p-5 space-y-4 relative">
                    ...
                    {/* Footer Actions */}
                    <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto relative z-50 pointer-events-auto">
                    ...
                    <div className="absolute inset-x-0 bottom-6 flex justify-center z-30 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                        <Link
